    ...
    Public Class printdoc
        ...
        Protected Overrides Sub OnPrintPage(ByVal ev As Printing.PrintPageEventArgs)
            ...
            Dim rectPrintingAreaItem As New RectangleF(intMarginLeft, intMarginTop + iDateHeight _
                                     + iHeaderHeight + iAddressHeight, intPrintAreaWidth, intPrintAreaHeight)  'To set Item Printable area

            'Dim rectPrintingAreaItemItalic As New RectangleF(intMarginLeft, intMarginTop + iDateHeight _
            '+ iHeaderHeight + iAddressHeight + iItemHeight, intPrintAreaWidth, intPrintAreaHeight)  'To set Italic Item Printable area

            Dim rectPrintingAreaNetPay As New RectangleF(intMarginLeft, intMarginTop + iDateHeight _
                         + iHeaderHeight + iAddressHeight + iItemHeight, intPrintAreaWidth, intPrintAreaHeight) 'To set NetPay Printable area  + iItemHeightItalic

            Dim rectPrintingAreaViaPay As New RectangleF(intMarginLeft, intMarginTop + iDateHeight _
                        + iHeaderHeight + iAddressHeight + iItemHeight + iNetpayHeight, intPrintAreaWidth, intPrintAreaHeight)   'to set Viapay printable area + iItemStarterHeight



            Dim rectPrintingAreaCustomerAddress As New RectangleF(intMarginLeft, intMarginTop + iDateHeight _
                                     + iHeaderHeight + iAddressHeight + iItemHeight + iNetpayHeight + iViapaidHeight, intPrintAreaWidth, intPrintAreaHeight)  'To set Customer Address Printable area

            Dim rectPrintingAreaFooter As New RectangleF(intMarginLeft, intMarginTop + iDateHeight + iHeaderHeight _
                                       + iAddressHeight + iItemHeight + iNetpayHeight + iViapaidHeight + iCustomerAddressHeight, intPrintAreaWidth, intPrintAreaHeight)  'To set Header Printable area
            ...
            ev.Graphics.MeasureString(Mid(strNetpay, UpgradeZeros(intCurrentChar)), fntNetpay, _
                  New SizeF(intPrintAreaWidth, intPrintAreaHeight), objSF, intCharsFitted, intLinesFilled)

            ev.Graphics.DrawString(Mid(strNetpay, UpgradeZeros(intCurrentChar)), fntNetpay, _
                        Brushes.Black, rectPrintingAreaNetPay, objSF)

            ev.Graphics.MeasureString(Mid(strviapaid, UpgradeZeros(intCurrentChar)), fntviapaid, _
                     New SizeF(intPrintAreaWidth, intPrintAreaHeight), objSF, intCharsFitted, intLinesFilled)

            ev.Graphics.DrawString(Mid(strviapaid, UpgradeZeros(intCurrentChar)), fntviapaid, _
                        Brushes.Black, rectPrintingAreaViaPay, objSF)
...
Public Class PrintDirectt
    ...
    Public Function OnCutter(ByVal tmpPrinterName As String) As Boolean
        ...
        dii.pDocName = "Uysys_Cutter"
        dii.pDataType = "RAW"

        PrintDirectt.OpenPrinter(tmpPrinterName, lhPrinter, 0)
        PrintDirectt.StartDocPrinter(lhPrinter, 1, dii)
        PrintDirectt.StartPagePrinter(lhPrinter)
        Try
            PrintDirect.WritePrinter(lhPrinter, st1, st1.Length, pcWritten)
        Catch ex As Exception
            Console.WriteLine(ex.Message)
        End Try
        PrintDirectt.EndPagePrinter(lhPrinter)
        PrintDirectt.EndDocPrinter(lhPrinter)
        PrintDirectt.ClosePrinter(lhPrinter)
    End Function
    ...
    Public Function OpenCashDrawer(ByVal tmpPrinterName As String) As Boolean
        ...
        dii.pDocName = "Uysys_CashDrawerOpen"
        dii.pDataType = "RAW"
        ...
        PrintDirectt.StartPagePrinter(lhPrinter)
        Try
            PrintDirectt.WritePrinter(lhPrinter, st2, st2.Length, pcWritten)
        Catch ex As Exception
            Console.WriteLine(ex.Message)
        End Try
        PrintDirectt.EndPagePrinter(lhPrinter)
