...
#Region "Protected Members"
    ...
    Protected _fntTextNormal As Font = New Font("Tahoma", 13, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTextHover As Font = New Font("Tahoma", 10, FontStyle.Bold, GraphicsUnit.Pixel)
