...
Public Class dailsalesreport_chart
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "dailsalesreport_chart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddailsalesreport_chart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As dailsalesreport_chart = New dailsalesreport_chart
        rpt.Site = Me.Site
        Return rpt
    End Function
