...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlItem.Controls.Add(Me.cboType)
        Me.pnlItem.Location = New System.Drawing.Point(7, 13)
        Me.pnlItem.Name = "pnlItem"
        Me.pnlItem.Size = New System.Drawing.Size(321, 163)
        ...
        Me.cboMeasurementUnit.Location = New System.Drawing.Point(136, 68)
        Me.cboMeasurementUnit.Name = "cboMeasurementUnit"
        Me.cboMeasurementUnit.Size = New System.Drawing.Size(40, 23)
        Me.cboMeasurementUnit.TabIndex = 8
        Me.cboMeasurementUnit.Visible = False
        '
        'Label7
        '
        ...
        Me.Label6.Location = New System.Drawing.Point(256, 70)
        ...
        Me.txtDineInPrice.Location = New System.Drawing.Point(144, 168)
        ...
        Me.txtDineInPrice.Visible = False
        '
        'Label4
        '
        ...
        Me.txtTakeawayPrice.Location = New System.Drawing.Point(136, 69)
        ...
        Me.Label2.Location = New System.Drawing.Point(88, 67)
        ...
        Me.cboItemLocation.Location = New System.Drawing.Point(136, 95)
        ...
        Me.lblMessage2.Location = New System.Drawing.Point(8, 132)
        ...
        Me.txtItemDesc.Location = New System.Drawing.Point(134, 160)
        ...
        Me.txtItemName.Location = New System.Drawing.Point(133, 40)
        Me.txtItemName.MaxLength = 50
        Me.txtItemName.Name = "txtItemName"
        Me.txtItemName.Size = New System.Drawing.Size(83, 21)
        ...
        Me.txtItemSC.Location = New System.Drawing.Point(136, 40)
        Me.txtItemSC.MaxLength = 20
        Me.txtItemSC.Name = "txtItemSC"
        Me.txtItemSC.Size = New System.Drawing.Size(160, 21)
        ...
        Me.cboType.Location = New System.Drawing.Point(96, 8)
        ...
        Me.pnlCatagorybtn.Location = New System.Drawing.Point(8, 256)
        ...
        Me.btnExit.Location = New System.Drawing.Point(242, 15)
        ...
        Me.btnDelete.Location = New System.Drawing.Point(162, 14)
        ...
        Me.btnEdit.Location = New System.Drawing.Point(82, 14)
        ...
        Me.btnAdd.Location = New System.Drawing.Point(8, 13)
        ...
        Me.Label3.Size = New System.Drawing.Size(72, 44)
        ...
        Me.lblMessage1.Size = New System.Drawing.Size(175, 37)
        ...
        Me.btnSelectType.Size = New System.Drawing.Size(48, 41)
        ...
        Me.lvLookUp.Location = New System.Drawing.Point(8, 176)
        Me.lvLookUp.MultiSelect = False
        Me.lvLookUp.Name = "lvLookUp"
        Me.lvLookUp.Size = New System.Drawing.Size(320, 80)
        ...
        'cTypeSC
        '
        Me.cTypeSC.Text = "Item Name"
        Me.cTypeSC.Width = 317
        '
        'cTypeId
        '
        Me.cTypeId.Width = 0
        ...
        Me.Text = "Add Miscellaneous Item"
...
#End Region
    ...
    Private Function FillTypeCombo()
        ...
        Try
            ...
            strSQL = "SELECT cType_Name,nType_Id FROM tType WHERE nTypeActive = 1 and cType_Name like 'Mis%'"
            ...
            If CheckEmptyItemInfo() = False Then
               ...
               ' txtItemSC.Text = "no need"
                ...
                strSQLInsert = "INSERT INTO tItem(cItem_Name,cItem_SC,cItem_ServeLoc,cMeasurUnit,cItem_Desc," & _
                               ...
                               "dAccessTime) VALUES('Miscellaneous Item','" & Replace(Trim(txtItemSC.Text), "'", "''") & _
                ...
                'strSQLInsert = "INSERT INTO tItem(cItem_Name,cItem_SC,cItem_ServeLoc,cMeasurUnit,cItem_Desc," & _
                '          "nItem_Stock,mDinePrice,mTakeawayPrice,nItemActive,nType_Id,cUserId,cTerminal," & _
                '          "dAccessTime) VALUES('" & Replace(Trim(txtItemName.Text), "'", "''") & "','" & "no need" & _
                '          "','" & Replace(Trim(cboItemLocation.Text), "'", "''") & "','" & Replace(Trim(cboMeasurementUnit.Text), "'", "''") & _
                '          "','" & Replace(Trim(txtItemDesc.Text), "'", "''") & "',0," & CStr(dDineInPrice) & "," & CStr(dTakeawayPrice) & _
                '          ",1," & CStr(Trim(txtTypeID.Text)) & ",'" + user + "','" + sTerminal + "',GETDATE())"

                strSQLUpdate = "UPDATE tItem SET cItem_Name='Miscellaneous Item',cItem_SC='" & Replace(Trim(txtItemSC.Text), "'", "''") & _
                               "',cMeasurUnit='No Need',cItem_ServeLoc='" & Replace(Trim(cboItemLocation.Text), "'", "''") & _
    ...
    Private Sub cboMeasurementUnit_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboMeasurementUnit.SelectedIndexChanged

    End Sub

    Private Sub pnlCatagorybtn_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles pnlCatagorybtn.Paint

    End Sub

    Private Sub lvLookUp_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvLookUp.SelectedIndexChanged

    End Sub

    Private Sub pnlItem_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles pnlItem.Paint

    End Sub

    Private Sub txtDineInPrice_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDineInPrice.TextChanged
    ...
    Private Sub cboItemLocation_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboItemLocation.SelectedIndexChanged
    ...
    Private Sub txtItemSC_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtItemSC.TextChanged
