Public Class frmToppingTakeway
    Inherits System.Windows.Forms.Form
    Dim bCboLoad As Boolean
    Dim conControlName As Control
    Dim objfrmdine As frmTakeaway
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnExit.Location = New System.Drawing.Point(256, 448)
        ...
        Me.btnAdd.Location = New System.Drawing.Point(168, 448)
        ...
        Me.Label3.Size = New System.Drawing.Size(72, 52)
        ...
        Me.lblMessage1.Size = New System.Drawing.Size(175, 45)
        ...
        Me.btnSelectType.Size = New System.Drawing.Size(48, 49)
        ...
        Me.pnlItem.Location = New System.Drawing.Point(28, 17)
        Me.pnlItem.Name = "pnlItem"
        Me.pnlItem.Size = New System.Drawing.Size(298, 415)
        Me.pnlItem.TabIndex = 25
        '
        'lvLookUp
        '
        ...
        Me.lvLookUp.Location = New System.Drawing.Point(1, 75)
        Me.lvLookUp.MultiSelect = False
        Me.lvLookUp.Name = "lvLookUp"
        Me.lvLookUp.Size = New System.Drawing.Size(296, 341)
...
#End Region
    ...
    Function frmToppingTakeaway(ByRef objTakeway As frmTakeaway)
        objfrmdine = objTakeway
    End Function
    ...
    Public Function addtoping()
        ...
        If typeName <> vbNullString Then
            ...
            objfrmdine.lvOrder.SelectedItems(0).SubItems(2).Text = mainprice + typePrice
            If cboins = vbNullString Then
                objfrmdine.lvOrder.SelectedItems(0).SubItems(3).Text = typeName
            Else
                objfrmdine.lvOrder.SelectedItems(0).SubItems(3).Text = typeName + "& " + cboins
            End If
            objfrmdine.CalculateTopingPrice()
        Else
            MsgBox("Item not Selected")
            'objfrmdine.lvOrder.SelectedItems(0).SubItems(2).Text = mainprice
            'objfrmdine.CalculateTopingPrice()
        End If
    End Function
    ...
    Private Sub cboInstruction_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboInstruction.SelectedIndexChanged
